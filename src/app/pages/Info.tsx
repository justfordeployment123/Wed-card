...
function Icon() {
  return (
    <div className="absolute h-[852px] left-[255px] top-0 w-[128px]" data-name="Icon">
...
export default function Info() {
  ...
  return (
    <div className="bg-[#f5f4f0] relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] min-h-screen w-full flex items-start justify-center px-4 sm:px-0" data-name="iPhone 16 - 62">
      <div className="relative w-full max-w-[393px] pb-12">
        {/* Decorative Icon */}
          ...
          <div className="mt-12 space-y-8">
            ...
            <div className="pt-8">
              ...
              <p className="font-['Marcellus:Regular',sans-serif] leading-[16px] text-[#717070] text-[14px] tracking-[0.6px] uppercase">
                si tienes alguna pregunta adicional. puedes escribirle a nuestra wedding planner via whatsapp al <br />
                + 573134423895
              </p>
            </div>
          </div>
